...
/**
 * Class m221025_132104_change_columns_in_map_points_table
 */
class m221025_132104_change_columns_in_map_points_table extends Migration
{
    /**
     * {@inheritdoc}
     */
...
//        $this->addColumn(\backend\models\MapPoints::tableName(), 'bottom_right_point_y', \yii\db\Schema::TYPE_DOUBLE);
    ...
    {
        echo "m221025_132104_change_columns_in_map_points_table cannot be reverted.\n";
